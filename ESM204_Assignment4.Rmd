...
```
>>>>>>> c4165dbe0a446cb73ad0a8e06b98f72aa45aad6d
...
MCa<-(-0.577*100) + 95.19 
MCb<-(-0.199*100) + 49.07
MCc<-(-0.784*100) + 160.79
MC<-rbind(MCa, MCb, MCc, NA)
costa<-(MCa*100)+(100*(95.19-MCa)*0.5)
costb<-(MCb*100)+(100*(49.07-MCb)*0.5)
costc<-(MCc*100)+(100*(160.79-MCc)*0.5)
